...
function getCategories() {
    fetch(uri)
        ...
        .catch(error => console.error('Unable to get tours.', error));
}
...
function addCategory() {
    ...
    fetch(uri, {
        ...
        .catch(error => console.error('Unable to add tour.', error));
}
...
function _displayTours(data) {
    const tBody = document.getElementById('tours');
    tBody.innerHTML = '';
